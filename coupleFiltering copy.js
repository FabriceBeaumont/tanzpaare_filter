document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderCouples(couples) {
        ...
        couples.forEach(couple => {
            ...
            if (couple.wdsfCouple && couple.wdsfCouple.trim() !== "") {
                ...
                coupleDiv.appendChild(wdsfLeaderDiv);
            }
    ...
    function updateCoupleDisplay() {
        ...
        document.querySelectorAll('.couple-item').forEach(coupleDiv => {
            ...
            const latinLevel = coupleDiv.dataset.latinLevel ? coupleDiv.dataset.latinLevel : null;
            const ballroomLevel = coupleDiv.dataset.ballroomLevel ? coupleDiv.dataset.ballroomLevel : null;
            ...
            const latinLevelMatch = latinLevelFilter === 'all' || (latinLevel && latinLevel.includes(latinLevelFilter)) || (latinLevelFilter === 'none' && latinLevel.includes(null));
            // Same for the ballroom level.
            const ballroomLevelMatch = ballroomLevelFilter === 'all' || (ballroomLevel && ballroomLevel.includes(ballroomLevelFilter)) || (ballroomLevelFilter === 'none' && ballroomLevel.includes(null));
